package vliegenier04.playerLocator.main.handler;
...
public class ConfigurationHandler {
    ...
    public static final String PL_DIRECTORY_STR = "./";
    public static final File PL_DIRECTORY_DEFAULT = new File(PLMain.proxy.getDataDirectory(), PL_DIRECTORY_STR);
