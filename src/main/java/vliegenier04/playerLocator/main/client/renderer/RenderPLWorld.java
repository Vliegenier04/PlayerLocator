package vliegenier04.playerLocator.main.client.renderer;
...
import vliegenier04.playerLocator.main.client.renderer.shader.ShaderProgram;
import vliegenier04.playerLocator.main.client.world.playerLocatorWorld;
import vliegenier04.playerLocator.main.handler.ConfigurationHandler;
...
public class RenderPLWorld extends RenderGlobal {
    public static final RenderPLWorld INSTANCE = new RenderPLWorld(Minecraft.getMinecraft());
    ...
    private static final ShaderProgram SHADER_ALPHA = new ShaderProgram("playerlocator", null, "shaders/alpha.frag");
    ...
    private playerLocatorWorld world;
    ...
    private PLChunkRendererContainer renderContainer;
    ...
    private IPLRenderChunkFactory renderChunkFactory;
    ...
    public RenderPLWorld(final Minecraft minecraft) {
        super(minecraft);
        this.mc = minecraft;
