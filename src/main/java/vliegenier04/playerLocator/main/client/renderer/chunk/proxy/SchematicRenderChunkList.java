package vliegenier04.playerLocator.main.client.renderer.chunk.proxy;

import vliegenier04.playerLocator.main.client.renderer.SchematicRenderCache;
    ...
    public void rebuildChunk(final float x, final float y, final float z, final ChunkCompileTaskGenerator generator) {
        ...
        try {
            if (generator.getStatus() == ChunkCompileTaskGenerator.Status.COMPILING) {
                ...
                final playerLocatorWorld schematic = (playerLocatorWorld) this.world;
