package vliegenier04.playerLocator.main.client.renderer.chunk.overlay;

import com.github.lunatrius.core.client.renderer.GeometryMasks;
import com.github.lunatrius.core.client.renderer.GeometryTessellator;
import vliegenier04.playerLocator.main.client.renderer.chunk.CompiledOverlay;
import vliegenier04.playerLocator.main.client.world.playerLocatorWorld;
import vliegenier04.playerLocator.main.PLMain;
import vliegenier04.playerLocator.main.client.renderer.RenderPLWorld;
...
public class RenderOverlay extends RenderChunk {
    ...
    public void rebuildChunk(final float x, final float y, final float z, final ChunkCompileTaskGenerator generator) {
        ...
        final playerLocatorWorld pLW = (playerLocatorWorld) this.world;
        ...
        try {
            ...
            if (from.getX() < 0 || from.getZ() < 0 || from.getX() >= PLMain.getWidth() || from.getZ() >= PLMain.getLength()) {
