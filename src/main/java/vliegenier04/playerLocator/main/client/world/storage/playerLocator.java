package vliegenier04.playerLocator.main.client.world.storage;
...
public class playerLocator implements IPlayerLocator {
    ...
    public playerLocator(final ItemStack icon, final int width, final int height, final int length) {
        this(icon, width, height, length, "");
    }

    public playerLocator(final ItemStack icon, final int width, final int height, final int length, @Nonnull final String author) {
        if (author == null) {
